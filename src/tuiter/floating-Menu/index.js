...
const BlackgroundColorPosition = { bottom: 24, right: 120 };

const ParticleEffectFab = ({
                 event = "hover",
...
const BackgroundColorFab = ({
                 event = "hover",
                 position = BlackgroundColorPosition,
                 alwaysShowTitle = false,
                 children,
                 icon,
                 mainButtonStyles
...
export { ParticleEffectFab, BackgroundColorFab, AB as Action };

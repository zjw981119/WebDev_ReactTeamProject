    ...
    return (
        <div className="ttr-edit-profile">
            <div className="border border-secondary border-bottom-0" style={{"marginBottom": "60px"}}>
                <Link to={{pathname: "/tuiter/game/:" + RawgId}} state={{"RawgId": RawgId, "GameName": GameName}}
            ...
            {User ? <h6 className="p-3 mb-2 fw-bolder">Hi {User.username}! Thank you for sharing your game experience
                with {GameName}.</h6> : <h6>Loading </h6>}
            <form className="p-2">
                ...
                <Link to={{pathname: "/tuiter/game/:" + RawgId}} state={{"RawgId": RawgId, "GameName": GameName}}
                      className="btn btn-light rounded-pill fa-pull-middle fw-bolder mt-1 mb-2 me-2"
